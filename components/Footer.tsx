...
const gamingPlatforms = [
  ...
  { label: "IPL Cricket Gaming ID", href: "#" },
  { label: "Online Gaming ID India", href: "#" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Mahadev Book Gaming Portal India’s most trusted sports insights and fantasy analytics service. Offering live odds, gaming tips, and gaming IDs across the country from 2018
            </p>
          ...
          {/* Column 3: Gaming Platforms */}
          <div>
            <h3 className="text-white font-bold text-lg mb-5">
              Supported Platforms
            </h3>
            <ul className="space-y-3">
              {gamingPlatforms.map((link, i) => (
                <li key={i}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-yellow-400 transition-colors text-sm flex items-center gap-2 group"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            ...
            <p className="text-gray-600 text-xs max-w-md">
              Mahadev Bookis an online gaming platform. You must be{" "}
