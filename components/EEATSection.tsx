...
const eeatCards = [
  ...
  },
  {
    icon: Crown,
    title: "Authority",
    desc: "Recognized as India’s leading gaming platform by industry authorities",
    highlight: false,
  },
  {
    icon: ShieldCheck,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            The officially licensed website of Mahadev Bookthat you can use to access the best gaming and gaming services. With years of gaming expertise and over 15 years of experience, we are in the best position to offer you the best and most reliable online gaming services in India trusted by 1.2M+ active users.
          </p>
